...
export const FRONT_MUSCLES: Partial<Record<MuscleId, string>> = {
  ...
  traps:
    "M118 76 L118 98 C 107 100, 96 105, 88 112 C 83 108, 81 100, 85 94 C 95 85, 107 79, 118 76 Z",
  front_delts:
  ...
  chest:
    "M118 116 C 103 115, 91 120, 85 130 C 81 141, 83 158, 90 167 C 99 175, 112 176, 118 172 Z",
  abs:
  ...
  biceps:
    "M63 158 C 52 170, 44 190, 43 212 C 42 228, 45 240, 51 241 C 57 241, 60 232, 61 218 C 62 198, 64 176, 68 162 Z",
  forearms:
    "M56 248 C 46 266, 37 290, 34 312 C 32 328, 33 344, 39 349 C 45 350, 48 343, 49 332 C 50 312, 53 288, 58 264 Z",
...
export const BACK_MUSCLES: Partial<Record<MuscleId, string>> = {
  ...
  triceps:
    "M62 156 C 51 169, 43 189, 42 211 C 41 227, 44 239, 50 240 C 56 240, 59 231, 60 217 C 61 197, 63 175, 67 161 Z",
  forearms:
    "M56 248 C 46 266, 37 290, 34 312 C 32 328, 33 344, 39 349 C 45 350, 48 343, 49 332 C 50 312, 53 288, 58 264 Z",
  glutes:
